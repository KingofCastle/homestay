...
<div style="width:100%; overflow: auto">
    <table id="contentTable"  style="table-layout:fixed;" class="table table-striped table-bordered table-condensed">
        ...
        <th class="span1" >jsVersion</th>
        <th class="span1" >supportMinVersion</th>
        <th class="span1" >下载url</th>
        <th class="span1" >bundle_url</th>
        ...
        <c:forEach items="${page.list}" var="version">
            <tr>
                ...
                <td>${version.jsVersion}</td>
                <td>${version.supportMinVersion}</td>
                <td><c:if test="${'0' eq version.delFlag }"><a href="${version.url}" target="_blank">下载url</a></c:if></td>
                <td><c:if test="${'0' eq version.delFlag && not empty version.bundleUrl}"><a href="${version.bundleUrl}" target="_blank">下载</a></c:if></td>
