            ...
            $("#cancelButton").click(function () {
                ...
                if ("CANCEL"==orderStatus || "FINISH"== orderStatus){
                    ...
                    if (confirm("取消订单后无法恢复，确定要取消该单吗？")) {
                        ...
                        window.location.href = "${ctx}/posthouse/post/task/cancel?taskId=" + taskId;
                    }
                }
...
<ul class="nav nav-tabs">
	<li class="active"><a href="${ctx}/posthouse/post/task/list">所有记录</a></li>
</ul>
<br/>
...
<form:form id="inputForm" modelAttribute="task" action="" method="post"
	...
	<table class="table table-bordered">
		...
		<tr>
			<td>支付状态</td>
			<td>${task.payStatus}</td>
		</tr>
		<tr>
			<td>商家id</td>
			<td><a href="${ctx}/wenwen/userInfo/merchantUserForm?id=${task.userId}">${task.userId}</a></td>
		</tr>
		<tr>
			<td>商家名称</td>
		...
		<tr>
			<td>服务商id</td>
			<td><a href="${ctx}/posthouse/provider/form?id=${task.providerId}">${task.providerId}</a></td>
		</tr>
		<tr>
			<td>服务商名称</td>
			<td><label class="lbl">${task.providerName}</label></td>
		</tr>
		<tr>
			<td>商家手机</td>
		...
		<tr>
			<td>未妥投时间</td>
			<td><label class="lbl"><fmt:formatDate value="${task.unsettledTime}" pattern="yyyy-MM-dd HH:mm:ss" type="date"/></label></td>
		</tr>
		<tr>
			<td>送达时间</td>
	...
	<table class="table table-bordered">
		...
		<tr>
			<td>骑手编号</td>
			<td><a href="${ctx}/wenwen/userInfo/riderUserForm?id=${task.riderId}">${task.riderId}</a></td>
		</tr>
		<tr>
			<td>骑手名称</td>
