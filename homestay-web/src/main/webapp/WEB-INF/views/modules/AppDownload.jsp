...
<div id="Phone-block" class="hide">
    ...
    <div class="btn-block">
        <a id="link-qishou" href="#">兔波波-骑手端</a>
        <a id="link-shangjia" href="#">兔波波-商家端</a>
    </div>
</div>
    ...
    window.onload=function () {
        ...
        var loadHrefs = {
            ...
            iosURL: [
                ...
                // 商家端
                'https://itunes.apple.com/cn/app/%E5%85%94%E6%B3%A2%E6%B3%A2/id1233184317?mt=8',
            ],
            // 安卓骑手端|商家端
            androidURL: [
                // 骑手端
                'http://tubobo-sc.oss-cn-shanghai.aliyuncs.com/android/toobob-rider.apk',
                // 商家端
                'http://tubobo-sc.oss-cn-shanghai.aliyuncs.com/android/toobob-merchant.apk',
            ],
        }
        /**
         * [browser 设备判断]
        ...
        function setTagHrefs(hrefs) {
            var ids = ['link-qishou', 'link-shangjia'];
            document.getElementById(ids[0]).href = hrefs[0];
            document.getElementById(ids[1]).href = hrefs[1];
        }
