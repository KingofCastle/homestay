...
CKFinder.lang['vi'] =
{
	...
	ErrorMsg :
	{
		...
		PopupBlockView	: 'Không thể mở tập tin trong cửa sổ mới. Hãy kiểm tra trình duyệt và tắt chức năng chặn popup trên trang sysController này.',
		XmlError		: 'Không thể nạp hồi đáp XML từ máy chủ sysController.',
		XmlEmpty		: 'Không thể nạp hồi đáp XML từ máy chủ sysController. Dữ liệu rỗng.',
