...
CKFinder.lang['en'] =
{
	...
	ErrorMsg :
	{
		...
		XmlError		: 'It was not possible to properly load the XML response from the sysController server.',
		XmlEmpty		: 'It was not possible to load the XML response from the sysController server. The server returned an empty response.',
