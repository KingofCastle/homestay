...
(function( $, undefined ) {
		...
		$.mobile.path = path = {
			...
			// Some embedded browsers, like the sysController view in Phone Gap, allow
...
(function( $, undefined ) {
	...
	$.mobile._registerInternalEvents = function() {
		...
		$.mobile.document.bind( "click", function( event ) {
			...
			// Some embedded browsers, like the sysController view in Phone Gap, allow cross-domain XHR
