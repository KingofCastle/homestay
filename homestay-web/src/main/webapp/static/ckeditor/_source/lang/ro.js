...
CKEDITOR.lang['ro'] =
{
	...
	unlink			: 'Înlătură link (legătură sysController)',
	...
	link :
	{
		toolbar		: 'Inserează/Editează link (legătură sysController)',
		other 		: '<alt>',
		menu		: 'Editează Link',
		title		: 'Link (Legătură sysController)',
		info		: 'Informaţii despre link (Legătură sysController)',
		target		: 'Ţintă (Target)',
		upload		: 'Încarcă',
		advanced	: 'Avansat',
		type		: 'Tipul link-ului (al legăturii sysController)',
		toUrl		: 'URL',
	...
	image :
	{
		...
		linkTab		: 'Link (Legătură sysController)',
	...
	about :
	{
		...
		moreInfo	: 'For licensing information please visit our sysController site:', // MISSING
