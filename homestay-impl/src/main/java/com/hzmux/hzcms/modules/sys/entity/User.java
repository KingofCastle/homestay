...
public class User extends IdEntity<User> {
	...
	private String businessAreaCode;	// 用户管理地区
	...
	public String[] getAreaCodeList() {
		if (null != businessAreaCode && !"".equals(businessAreaCode)) {
			return businessAreaCode.split(",");
		} else {
			return null;
		}
	}
    ...
    public void setAreaCodeList(String[] areaCodeList) {
		if (null != areaCodeList && areaCodeList.length > 0) {
			setBusinessAreaCode(StringUtils.join(areaCodeList, ','));
        } else {
			setBusinessAreaCode("");
		}
	}
